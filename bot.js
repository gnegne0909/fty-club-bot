...
async function registerCommands() {
    ...
    // Supprimer les commandes globales qui masquent les guild commands
    try {
...
// Route racine (Render health check - OBLIGATOIRE pour éviter les redémarrages)
app.get('/', (req, res) => {
    res.json({
        status: 'ok',
        bot: 'FTY Club Pro',
