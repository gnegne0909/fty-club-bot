...
async function registerCommands() {
    ...
    try {
        ...
        // Supprimer les commandes globales (qui pourraient masquer les guild commands)
        ...
        console.log(`✅ ${commands.length} commandes slash enregistrées sur le serveur`);
        botStatus.commands = commands.map(c => c.name);
        addBotLog(`${commands.length} commandes enregistrées: ${botStatus.commands.join(', ')}`);
    } catch (error) {
