...
// ============================================================
// ── Timeout de sécurité : si pas de ready en 30s, log l'erreur ──
const loginTimeout = setTimeout(() => {
    console.error('');
    console.error('╔══════════════════════════════════════════════════════╗');
    console.error('║  ❌ TIMEOUT: Bot non connecté après 30 secondes     ║');
    console.error('║  → Discord WebSocket inaccessible depuis Render      ║');
    console.error('║  → Vérifiez les Privileged Intents :                ║');
    console.error('║    discord.com/developers → Bot → activer :         ║');
    console.error('║    • PRESENCE INTENT                                 ║');
    console.error('║    • SERVER MEMBERS INTENT                           ║');
    console.error('║    • MESSAGE CONTENT INTENT                          ║');
    console.error('╚══════════════════════════════════════════════════════╝');
    addBotLog('❌ Timeout connexion Discord (30s)', 'error');
